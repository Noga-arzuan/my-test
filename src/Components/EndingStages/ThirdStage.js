  ...
  return (
    <div className="about">
...

      {
        showSummery ? 
        <p className="sumery">
                                  <br></br> טוב שאת פה. אל תתעלמי מהנורות האדומות.
אף מערכת יחסים אינה מושלמת, אבל במערכת יחסים בריאה לא תמצאי התנהגויות פוגעות.
חשוב שתשוחחי עם אדם  מחוץ למערכת היחסים ושתפי במה שעובר עלייך. 
הנה כמה אפשרויות שיכולות לעזור לך:
