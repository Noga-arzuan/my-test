...
הצעד הראשון הוא לפנות לגורמי מקצוע בתחום כבר עכשיו, כדי שישמעו אותך ויעזרו לך להבין איך לפעול נכון. 
חשוב לדעת! במקרים של זוגיות פוגענית, אסור לקבל החלטות לבד ובטח שלא להיפרד מבן הזוג ללא ליווי מקצועי. <br></br>
חייך עלולים להיות בסכנה.<br></br>
    הנה מה שאת צריכה לעשות:
...
אפשר גם לשלוח הודעה 24/7 למספר: 055-7000128
           ...
           <br></br>
            ...
            <button type="button" class="btn btn-link sendBtn wingsBtn" onClick={() => sendMsg()}>בלחיצה כאן</button><br></br>
              תועברי למסך בו יחכה עבורך טקסט קצר אותו תוכלי לשלוח לאדם עליו את סומכת
               (חבר/ה , קרוב/ת משפחה או כל אדם אחר שתבחרי) 
