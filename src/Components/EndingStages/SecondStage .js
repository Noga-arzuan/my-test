...
const SecondStage = () => {
  ...
  return (
    ...
    חשוב לדבר עם בן הזוג ולהבהיר לו מה מתאים לך ומה צריך להשתנות. תשמעי גם את הצד שלו, כי תקשורת טובה היא אבן היסוד של מערכת יחסים בריאה. כמו כן, מומלץ ללמוד עוד על ניהול זוגיות ומהם הסימנים של זוגיות פוגענית
