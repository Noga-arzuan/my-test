export const questions = [
  ...
  {
    questionText: "לבן זוג שלי מפריע שאני משקיעה בעצמי   ",
  ...
  {
    questionText: "שום דבר שאני עושה לא מספיק טוב בשבילו",
    answerOptions: [
  ...
  {
    questionText: "בכל הנוגע לקשר, בן זוגי מקבל את כל ההחלטות  ",
    answerOptions: [
  ...
  {
    questionText: "לעיתים קרובות בן זוגי גורם לי לפקפק בעצמי",
    answerOptions: [
      { answerText: "כל הזמן ", isCorrect: true },
  ...
  },
  {
    ...
    answerOptions: [
      { answerText: "בודק", isCorrect: true },
      { answerText: "לא בודק ", isCorrect: false },
    ],
  },
  {
