export const questions = [
  ...
  {
    questionText: " בן הזוג שלי חושד  שאני לא מספיק נאמנה",
  ...
  {
    questionText:
      'עולה בי מחשבה שאם אספר למישהו על מה שקורה באמת ביני לבין בן זוגי כשרק שנינו לבד, אנשים לא יאמינו כי הוא משדר כלפי חוץ דמות של "קסם" של בחור',
    answerOptions: [
      { answerText: "לא יאמינו", isCorrect: true },
      { answerText: "יאמינו ", isCorrect: false },
    ],
  },

  {
    ...
    answerOptions: [
      { answerText: "קרה", isCorrect: true },
      { answerText: "לא קרה", isCorrect: false },
    ],
  },
  ...
  {
    questionText: " בן הזוג שלי טוען שהוא היחיד שיסכים להיות איתי",
    answerOptions: [
  ...
  {
    questionText: "אני אמורה להיות בבית כשבן הזוג שלי חוזר מהעבודה",
    answerOptions: [
  ...
  {
    questionText: " בן זוגי עוקב אחרי ההודעות והמיילים שלי     ",
    answerOptions: [
  ...
  },
  {
    ...
    answerOptions: [
      { answerText: "לא מאשים", isCorrect: false },
      { answerText: "כן מאשים ", isCorrect: true },
    ],
  },
  {
    questionText: "בן זוגי אוסר עליי לשתף אחרים לגבי הזוגיות שלנו",
    answerOptions: [
      { answerText: "אוסר", isCorrect: true },
      { answerText: "לא אוסר", isCorrect: false },
    ],
  },
  {
    questionText: "בן הזוג שלי  מכריח אותי   לעשות דברים שאני לא רוצה בסקס ",
    answerOptions: [
  ...
  {
    questionText: " בן זוגי מתעצבן מכל דבר קטן שאני עושה",
    answerOptions: [
